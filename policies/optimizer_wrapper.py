...
class OptimizerWrapper:
    ...
    def basic_drsom(self, **closure):
        return self._optimizer.basic_drsom(**closure)

    def compute_alpha_TRPO(self, **closure):
        return self._optimizer.compute_alpha_TRPO(**closure)
    
    def compute_alpha_NPG_fixed(self, **closure):
        return self._optimizer.compute_alpha_NPG_fixed(**closure)

    def compute_alpha_NPG_opt(self, **closure):
        return self._optimizer.compute_alpha_NPG_opt(**closure)

    def drsom_linesearch_g(self, **closure):
        self._optimizer.drsom_linesearch_g(**closure)

    def compute_alpha_hassian_aid_NPG_opt(self, **closure):
        self._optimizer.compute_alpha_hassian_aid_NPG_opt(**closure) 
